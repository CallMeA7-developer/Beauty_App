/*
  # Add Makeup Product Columns and Insert 90 Makeup Products

  1. Schema Changes
    - Add `finish` column (text) - Matte/Satin/Shimmer/Glitter
    - Add `coverage` column (text) - Sheer/Medium/Full
    - Add `skin_tone` column (text) - Fair/Light/Medium/Tan/Deep/All Tones

  2. Data
    - Insert 90 realistic makeup products with varied:
      - Subcategories: Foundation, Concealer, Powder, Blush, Highlighter, Eyeshadow, Eyeliner, Mascara, Eyebrow, Lipstick, Lip Gloss, Lip Liner, Lip Care
      - Brands: Shan Loray, MAC, Charlotte Tilbury, NARS, Fenty Beauty, Urban Decay, Too Faced, Maybelline, Dior Beauty, YSL Beauty
      - Prices: $15-$120
      - Ratings: 3.5-5.0
      - Real Unsplash makeup images
      - Realistic finish, coverage, and skin_tone values
*/

-- Add makeup-specific columns if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
...
('makeup_068', 'Legendary Lashes Mascara', 'Makeup', 'Mascara', 'Shan Loray', '34', '4.6', 'https://images.unsplash.com/photo-1616683693504-3ea7e9ad6fec?w=800', 'Volume and length mascara with nourishing formula', 'Matte', 'Full', 'All Tones'),
...
('markup_079', 'Melted Matte Lipstick', 'Makeup', 'Lipstick', 'Too Faced', '25', '4.5', 'https://images.unsplash.com/photo-1571875257727-256c39da42af?w=800', 'Liquified matte lipstick', 'Matte', 'Full', 'All Tones'),
