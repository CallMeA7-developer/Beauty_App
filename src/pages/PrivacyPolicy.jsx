  ...
  const sections = [
    {
      ...
      content: t('privacyPolicy.sections.collect.items', { returnObjects: true })
    },
    {
      key: 'use',
      icon: IoShieldCheckmarkOutline,
      content: t('privacyPolicy.sections.use.items', { returnObjects: true })
    },
    {
      key: 'security',
      icon: IoLockClosedOutline,
      content: t('privacyPolicy.sections.security.items', { returnObjects: true })
    },
    {
      key: 'sharing',
      icon: IoGlobeOutline,
      content: t('privacyPolicy.sections.sharing.items', { returnObjects: true })
    },
    {
      key: 'rights',
      icon: IoShieldCheckmarkOutline,
      content: t('privacyPolicy.sections.rights.items', { returnObjects: true })
    },
    {
      key: 'cookies',
      icon: IoGlobeOutline,
      content: t('privacyPolicy.sections.cookies.items', { returnObjects: true })
    }
  ]
