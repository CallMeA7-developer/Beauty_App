...
export default function EditAddress() {
  ...
  const inputClass = "w-full h-[56px] border border-[#E8E3D9] rounded-[8px] px-[16px] text-[15px] font-normal text-[#1A1A1A] outline-none focus:border-[#8B7355] transition-colors"
  const labelClass = "text-[14px] font-medium text-[#1A1A1A] block mb-[8px]"
  ...
  return (
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[48px] bg-[#FDFBF7] px-[120px] flex items-center">
        ...
        <span className="text-[15px] font-normal text-[#666666] mx-2">/</span>
        <Link to="/shipping-address"><span className="text-[15px] font-normal text-[#8B7355] cursor-pointer">Shipping Addresses</span></Link>
        <span className="text-[15px] font-normal text-[#666666] mx-2">/</span>
      ...
      <div className="min-h-[600px] px-[120px] py-[48px]">
        <div className="max-w-[1200px] mx-auto flex gap-[40px]">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[40px]">
              <div className="space-y-[24px]">
                ...
                <div>
                  ...
                  <div className="relative">
                    <IoPhonePortraitOutline className="absolute left-[16px] top-1/2 -translate-y-1/2 w-[20px] h-[20px] text-[#666666]" />
                    <input
                      type="tel"
                      value={form.phone}
                ...
                {/* City / State */}
                <div className="grid grid-cols-[60%_1fr] gap-[16px]">
                  <div>
                    <label className={labelClass}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <IoChevronDown className="absolute right-[16px] top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#666666] pointer-events-none" />
                    </div>
                  </div>
                </div>

                {/* Postal / Country */}
                <div className="grid grid-cols-[40%_1fr] gap-[16px]">
                  <div>
                    <label className={labelClass}>
                ...
                <div className="flex items-center gap-[12px] cursor-pointer" onClick={() => update('isDefault', !form.isDefault)}>
                  <div className={`w-[20px] h-[20px] border-2 rounded-[4px] flex items-center justify-center flex-shrink-0 transition-colors ${form.isDefault ? 'bg-[#8B7355] border-[#8B7355]' : 'bg-white border-[#E8E3D9]'}`}>
                    {form.isDefault && <IoCheckmark className="w-[14px] h-[14px] text-white" />}
                  </div>
                  <span className="text-[15px] font-normal text-[#3D3D3D] select-none">Set as default shipping address</span>
                </div>
              </div>
              ...
              <div className="border-t border-[#E8E3D9] mt-[32px] pt-[32px]">
                <div className="flex items-center gap-[16px]">
                  <Link to="/shipping-address">
                    <button className="bg-white border border-[#E8E3D9] text-[#666666] text-[15px] font-medium px-[32px] py-[14px] rounded-[8px] cursor-pointer hover:border-[#8B7355] hover:text-[#8B7355] transition-all">
                      Cancel
                    </button>
                  </Link>
                  <button className="bg-[#8B7355] text-white text-[15px] font-medium px-[40px] py-[14px] rounded-[8px] flex items-center gap-[8px] cursor-pointer hover:bg-[#7a6448] transition-colors">
