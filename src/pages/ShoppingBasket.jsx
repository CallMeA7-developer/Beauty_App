  ...
  return (
    <div key={i18n.language} className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[48px] bg-[#FDFBF7] px-4 md:px-[60px] lg:px-[120px] flex items-center">
        <Link to="/"><span className="text-[13px] lg:text-[15px] font-normal text-[#8B7355] cursor-pointer">{t('shoppingBasket.home')}</span></Link>
        <span className="text-[13px] lg:text-[15px] font-normal text-[#666666] mx-2">/</span>
        <span className="text-[13px] lg:text-[15px] font-normal text-[#666666]">{t('shoppingBasket.title')}</span>
      </div>
      ...
      <div className="min-h-[90px] md:min-h-[110px] lg:min-h-[120px] bg-gradient-to-b from-[#FDFBF7] to-white flex flex-col items-center justify-center px-4 md:px-[60px] lg:px-[120px]">
        <div className="max-w-[1200px] w-full">
          <h1 className="text-[30px] md:text-[38px] lg:text-[48px] font-semibold text-[#1A1A1A]">{t('shoppingBasket.title')}</h1>
          <p className="text-[14px] md:text-[16px] lg:text-[18px] font-normal text-[#666666] mt-[6px] lg:mt-[8px]">{cartItems.length} {t('shoppingBasket.itemsInBasket')}</p>
        </div>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-[40px]">
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-5 md:p-6 lg:p-[32px]">
              {cartItems.length === 0 ? (
                <div className="text-center py-10 lg:py-[64px]">
                  <p className="text-[20px] lg:text-[24px] font-medium text-[#666666] mb-[24px]">{t('shoppingBasket.emptyBasket')}</p>
                  <Link to="/collections">
                    <button className="h-[48px] lg:h-[52px] px-[32px] lg:px-[40px] bg-[#8B7355] text-white text-[15px] lg:text-[16px] font-medium rounded-[8px] hover:bg-[#7a6448] transition-colors">
                      {t('shoppingBasket.startShopping')}
                    </button>
                  </Link>
                </div>
              ) : (
                      ...
                      <div className="flex-1 flex flex-col justify-between min-w-0">
                        ...
                        <div className="flex items-center gap-3 lg:gap-[20px] mt-3 lg:mt-0 flex-wrap">
                          <div className="flex items-center gap-[6px] lg:gap-[8px]">
                            <button onClick={() => updateQty(item.id, -1)} className="w-[32px] h-[32px] lg:w-[36px] lg:h-[36px] rounded-[8px] border-[1.5px] border-[#E8E3D9] flex items-center justify-center cursor-pointer hover:border-[#8B7355] transition-colors">
            ...
            <div className="mt-5 lg:mt-[24px]">
              <Link to="/collections">
                <button className="flex items-center gap-[8px] text-[14px] lg:text-[16px] font-medium text-[#8B7355] cursor-pointer hover:underline">
                  <span>{t('shoppingBasket.continueShopping')}</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-[20px] mt-5 lg:mt-[32px]">
              <div className="bg-[#FDFBF7] rounded-[8px] p-4 lg:p-[16px] flex gap-4 lg:gap-[16px]">
                ...
                <div>
                  <div className="text-[14px] lg:text-[16px] font-semibold text-[#1A1A1A] mb-[4px]">{t('shoppingBasket.freeShipping')}</div>
                  <div className="text-[12px] lg:text-[13px] font-normal text-[#666666]">{t('shoppingBasket.freeShippingDesc')}</div>
                </div>
              </div>
              <div className="bg-[#FDFBF7] rounded-[8px] p-4 lg:p-[16px] flex gap-4 lg:gap-[16px]">
                <IoReturnDownBackOutline className="w-[24px] h-[24px] lg:w-[28px] lg:h-[28px] text-[#8B7355] flex-shrink-0" />
                <div>
                  <div className="text-[14px] lg:text-[16px] font-semibold text-[#1A1A1A] mb-[4px]">{t('shoppingBasket.easyReturns')}</div>
                  <div className="text-[12px] lg:text-[13px] font-normal text-[#666666]">{t('shoppingBasket.easyReturnsDesc')}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[360px] lg:flex-shrink-0">
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-5 md:p-6 lg:p-[32px] lg:sticky lg:top-[24px]">
              <h2 className="text-[20px] md:text-[22px] lg:text-[24px] font-semibold text-[#1A1A1A] mb-5 lg:mb-[24px]">{t('shoppingBasket.orderSummary')}</h2>
                ...
                {cartItems.map(item => (
                  <div key={item.id} className="flex justify-between items-start gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="text-[12px] lg:text-[13px] font-light text-[#999999]">{t('shoppingBasket.qty')}: {item.quantity}</div>
                    </div>
              ...
              <div className="flex items-center justify-between mb-3 lg:mb-[16px]">
                <span className="text-[14px] lg:text-[16px] font-normal text-[#666666]">{t('shoppingBasket.subtotal')}</span>
                <span className="text-[14px] lg:text-[16px] font-normal text-[#1A1A1A]">${subtotal.toFixed(2)}</span>
              </div>

              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-[6px]">
                  <span className="text-[14px] lg:text-[16px] font-normal text-[#666666]">{t('shoppingBasket.shipping')}</span>
                  <IoInformationCircleOutline className="w-[14px] h-[14px] lg:w-[16px] lg:h-[16px] text-[#999999]" />
                </div>
                <span className="text-[14px] lg:text-[16px] font-normal text-green-600">{t('shoppingBasket.free')}</span>
              </div>
              <div className="text-[12px] lg:text-[13px] font-light text-[#999999] mb-3 lg:mb-[16px]">{t('shoppingBasket.standardDelivery')}</div>

              <div className="flex items-center justify-between mb-5 lg:mb-[24px]">
                <span className="text-[14px] lg:text-[16px] font-normal text-[#666666]">{t('shoppingBasket.estimatedTax')}</span>
              ...
              <div className="flex items-center justify-between mb-6 lg:mb-[32px]">
                <span className="text-[18px] lg:text-[20px] font-semibold text-[#1A1A1A]">{t('shoppingBasket.orderTotal')}</span>
              ...
              <div className="flex gap-[8px] mb-5 lg:mb-[24px]">
                <input
                  type="text"
                  placeholder={t('shoppingBasket.promoPlaceholder')}
              ...
              <Link to="/checkout">
                <button className="w-full h-[52px] lg:h-[56px] bg-[#8B7355] text-white text-[15px] lg:text-[16px] font-medium rounded-[8px] cursor-pointer hover:bg-[#7a6448] transition-colors mb-4 lg:mb-[16px]">
                  {t('shoppingBasket.proceedToCheckout')}
                </button>
              </Link>
              ...
              <div className="flex items-center justify-center gap-[8px]">
                ...
                <span className="text-[12px] lg:text-[13px] font-normal text-[#666666]">{t('shoppingBasket.secureCheckout')}</span>
              </div>
            </div>
          </div>
