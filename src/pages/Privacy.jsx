          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-5 md:p-6 lg:p-[32px]">
              ...
              <div className="flex flex-col sm:flex-row gap-3 lg:gap-[16px] mb-5 lg:mb-[24px]">
                <button className="flex-1 h-[48px] lg:h-[52px] bg-white border border-[#E8E3D9] text-[#666666] text-[14px] lg:text-[15px] font-medium rounded-[8px] flex items-center justify-center gap-2 hover:border-[#8B7355] hover:text-[#8B7355] transition-all">
                  <IoDownloadOutline className="w-[18px] h-[18px]" />
                  {t('privacyPage.download')}
                </button>
                <button className="flex-1 h-[48px] lg:h-[52px] bg-white border border-red-200 text-red-500 text-[14px] lg:text-[15px] font-medium rounded-[8px] flex items-center justify-center gap-2 hover:bg-red-50 transition-all">
