  ...
  return (
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[48px] bg-[#FDFBF7] px-[120px] flex items-center">
        ...
        <span className="text-[15px] text-[#666666]">Makeup</span>
      </div>
      <div className="px-[120px] py-[64px] flex gap-[48px]">
              ...
              {[{label:'Face',subs:faceCategories},{label:'Eyes',subs:eyesCategories},{label:'Lips',subs:lipsCategories}].map(({label,subs}) => (
                <div key={label}>
                  ...
                  <div className="ml-[24px] mt-[8px]">
                    {subs.map((item) => <div key={item} className="inline-block px-[16px] py-[6px] bg-white border border-[#E8E3D9] text-[#666666] text-[13px] rounded-full cursor-pointer mr-2 mb-2">{item}</div>)}
                  </div>
                </div>
              ))}
              <div className="inline-flex items-center px-[20px] py-[10px] bg-[#F5F1EA] text-[#3D3D3D] text-[14px] font-medium rounded-full cursor-pointer gap-2">
        ...
        <div className="flex-1">
          <div className="min-h-[64px] flex items-center justify-between mb-[48px]">
            <span className="text-[15px] text-[#666666]">Showing 42 of 156 makeup products</span>
              ...
              {horizontalProducts.map((product, idx) => (
                <div key={idx} className="w-full h-[270px] bg-white rounded-[12px] overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.08)] group cursor-pointer hover:shadow-[0_16px_48px_rgba(0,0,0,0.12)] transition-all duration-300 flex">
                  ...
                  <div className="flex-1 p-[24px] flex flex-col justify-center">
                    ...
                    {product.shades && <div className="flex items-center gap-[6px] mb-3">{product.shades.map((s,i) => <div key={i} className="w-[16px] h-[16px] rounded-full border border-[#E8E3D9]" style={{backgroundColor:s}} />)}</div>}
          ...
          <div className="grid grid-cols-3 gap-[20px] mb-[64px]">
            {squareProducts.map((product, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h4 className="text-[20px] font-medium text-[#2B2B2B] leading-[1.2] mb-2">{product.name}</h4>
                <p className="text-[15px] text-[#999999] mb-2">{product.description}</p>
                {product.shades && <div className="flex items-center gap-[6px] mb-2">{product.shades.map((s,i) => <div key={i} className="w-[16px] h-[16px] rounded-full border border-[#E8E3D9]" style={{backgroundColor:s}} />)}</div>}
          ...
          <div className="min-h-[140px] bg-[#F5F1EA] rounded-[16px] flex flex-col items-center justify-center px-[64px] mb-[96px]">
            ...
            <p className="text-[16px] text-[#666666] mb-6">Get early access to new makeup launches</p>
          ...
          <div className="flex items-center justify-center gap-[8px] mb-[96px]">
            ...
            {[2,3,4].map((n) => <button key={n} className="w-[44px] h-[44px] border border-[#E8E3D9] rounded-[6px] text-[15px] font-medium text-[#3D3D3D] hover:border-[#8B7355] hover:text-[#8B7355] transition-colors">{n}</button>)}
