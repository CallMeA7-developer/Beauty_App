    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[200px] bg-gradient-to-b from-[#FDFBF7] to-white flex flex-col items-center justify-center px-[120px]">
        <div className="max-w-[1200px] w-full">
          <div className="text-[13px] font-light text-[#666666] mb-[16px]">Home / Account Dashboard</div>
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              <div className="flex items-center justify-between mb-[24px]">
                ...
                <button className="flex items-center gap-[6px] text-[15px] font-medium text-[#8B7355] cursor-pointer hover:underline">
                  <IoCreateOutline className="w-[18px] h-[18px]" /> Edit
                </button>
              </div>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              <div className="flex items-center justify-between mb-[24px]">
                ...
                <button className="text-[15px] font-normal text-[#8B7355] cursor-pointer hover:underline">View All</button>
              </div>
              <div className="space-y-[20px]">
                {currentOrders.map((order) => (
                  <div key={order.orderNumber} className="border border-[#E8E3D9] rounded-[8px] p-[20px]">
                    <div className="flex items-start gap-[20px]">
                      <img src={order.image} alt={order.product} className="w-[80px] h-[80px] object-cover rounded-[8px]" />
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-[8px]">
                          <div>
                            <div className="text-[16px] font-medium text-[#1A1A1A] mb-[4px]">{order.product}</div>
                            <div className="text-[13px] font-light text-[#666666]">Order {order.orderNumber} • {order.date} • Qty: {order.quantity}</div>
                          </div>
                          <div className="bg-[#C9A870] text-white text-[12px] font-normal px-[12px] py-[4px] rounded-full">{order.status}</div>
                        </div>
                        <div className="flex items-center justify-between mt-[16px]">
                          ...
                          <button className="border border-[#8B7355] text-[#8B7355] text-[14px] font-medium px-[20px] py-[8px] rounded-[8px] cursor-pointer hover:bg-[#8B7355] hover:text-white transition-all">
                            Track Order
                          </button>
                        </div>
                      </div>
                ...
                {orderHistory.map((order, idx) => (
                  <div key={idx} className="flex items-center justify-between py-[16px] border-b border-[#F5F1EA]">
                    ...
                    <div className="flex items-center gap-[24px]">
                      ...
                      <button className="flex items-center gap-[6px] text-[14px] font-normal text-[#8B7355] cursor-pointer hover:underline">
                        <IoReloadOutline className="w-[16px] h-[16px]" /> Reorder
                      </button>
                    </div>
                  </div>
                ))}
              </div>
              <button className="w-full mt-[20px] text-[15px] font-normal text-[#8B7355] cursor-pointer hover:underline">
                View Full History
              </button>
            </div>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              <div className="flex items-center justify-between mb-[24px]">
                ...
                <Link to="/wishlist"><button className="text-[15px] font-normal text-[#8B7355] cursor-pointer hover:underline">View All 12 Items</button></Link>
              </div>
              <div className="grid grid-cols-4 gap-[16px]">
                {wishlistProducts.map((product, idx) => (
                  <div key={idx} className="cursor-pointer group">
                    <div className="relative mb-[12px]">
                      <img src={product.image} alt={product.name} className="w-full h-[160px] object-cover rounded-[8px] group-hover:scale-105 transition-transform duration-300" />
              ...
              <div className="bg-white rounded-[8px] p-[16px]">
                ...
                <div className="flex gap-[8px]">
                  {['Fine Lines', 'Hydration'].map((concern) => (
                    <div key={concern} className="bg-[#FDFBF7] text-[#8B7355] text-[13px] font-normal px-[12px] py-[6px] rounded-full border border-[#E8E3D9]">{concern}</div>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              ...
              <div className="flex items-center justify-center gap-[8px] bg-[#8B7355] text-white text-[14px] font-medium px-[20px] py-[12px] rounded-[8px] cursor-pointer hover:bg-[#7a6448] transition-colors">
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              <div className="flex items-center justify-between mb-[24px]">
                ...
                <Link to="/beauty-journey"><button className="text-[15px] font-normal text-[#8B7355] cursor-pointer hover:underline">View All Routines</button></Link>
              </div>
              <div className="grid grid-cols-2 gap-[20px]">
                {routines.map((routine) => (
                  <div key={routine.name} className="border border-[#E8E3D9] rounded-[8px] p-[20px] hover:border-[#C9A870] transition-colors">
                    <h4 className="text-[16px] font-medium text-[#1A1A1A] mb-[8px]">{routine.name}</h4>
                    <div className="text-[13px] font-normal text-[#666666] mb-[16px]">{routine.productCount} products • Last used {routine.lastUsed}</div>
                    <div className="flex gap-[8px]">
                      {routine.images.map((img, idx) => (
                        <img key={idx} src={img} alt="Product" className="w-[60px] h-[60px] object-cover rounded-[6px]" />
                      ))}
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[32px]">
              <div className="flex items-center justify-between mb-[24px]">
                ...
                <button className="text-[15px] font-normal text-[#8B7355] cursor-pointer hover:underline">View All Reviews</button>
              </div>
              <div className="space-y-[20px] mb-[24px]">
                {reviews.map((review, idx) => (
                  <div key={idx} className="border border-[#E8E3D9] rounded-[8px] p-[20px]">
                    <div className="flex gap-[16px]">
                      <img src={review.image} alt={review.product} className="w-[80px] h-[80px] object-cover rounded-[8px]" />
                      <div className="flex-1">
                        <div className="text-[16px] font-medium text-[#1A1A1A] mb-[8px]">{review.product}</div>
                        <div className="flex items-center gap-[4px] mb-[8px]">
                          {[...Array(5)].map((_, i) => <IoStarSharp key={i} className="w-[16px] h-[16px] text-[#C9A870]" />)}
                        </div>
              ...
              <button className="w-full bg-[#8B7355] text-white text-[15px] font-medium py-[12px] rounded-[8px] cursor-pointer hover:bg-[#7a6448] transition-colors">
                Write a Review
              </button>
            </div>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px]">
              ...
              <div className="grid grid-cols-2 gap-[16px]">
                {settingsItems.map((item) => (
                  <div key={item.label} className="border border-[#E8E3D9] rounded-[8px] p-[20px] cursor-pointer hover:border-[#C9A870] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        {item.count && <div className="text-[13px] font-normal text-[#666666]">{item.count}</div>}
                      </div>
