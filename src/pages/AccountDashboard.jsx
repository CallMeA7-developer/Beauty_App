        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[300px] bg-white shadow-[4px_0_24px_rgba(0,0,0,0.15)] flex flex-col overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#E8E3D9] flex-shrink-0">
              <span className="text-[16px] font-semibold text-[#1A1A1A]">{t('dashboard.accountDashboard')}</span>
            ...
            <div className="p-5 border-b border-[#E8E3D9]">
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[15px] font-medium text-[#8B7355]">{loyaltyPoints.toLocaleString()} {t('dashboard.points')}</span>
                </div>
              </div>
            </div>
                ...
                <Link key={item.label} to={item.path} onClick={() => setShowDrawer(false)}>
                  <div className={`flex items-center justify-between h-[46px] px-3 rounded-[8px] cursor-pointer transition-colors ${item.active ? 'bg-[#FDFBF7]' : 'hover:bg-[#FDFBF7]'}`}>
                    ...
                    {item.badge ? (
                      ...
                      <div className="bg-[#8B7355] text-white text-[9px] font-normal px-[7px] py-[2px] rounded-[4px]">{item.tag}</div>
                    ) : null}
                  </div>
                </Link>
              ))}
            ...
            <div className="p-5 border-b border-[#E8E3D9]">
              <div className="grid grid-cols-3 gap-3">
                <div className="text-center">
                  ...
                  <div className="text-[10px] font-light text-[#666666] leading-tight">{t('dashboard.totalOrders')}</div>
                </div>
                <div className="text-center">
                  <div className="text-[20px] font-semibold text-[#8B7355] mb-1">{wishlistCount}</div>
                  <div className="text-[10px] font-light text-[#666666] leading-tight">{t('dashboard.wishlistItems')}</div>
                </div>
                <div className="text-center">
                  <div className="text-[20px] font-semibold text-[#8B7355] mb-1">{reviewsCount}</div>
                  <div className="text-[10px] font-light text-[#666666] leading-tight">{t('dashboard.reviewsWritten')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 flex-shrink-0">
              <button
                ...
                className="w-full h-[48px] bg-[#8B7355] text-white text-[14px] font-medium rounded-[8px] flex items-center justify-center gap-2 hover:bg-[#7a6448] transition-colors"
              >
