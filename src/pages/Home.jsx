    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <section className="w-full min-h-[680px] bg-white py-[96px] relative">
        ...
        <div className="px-[120px] relative">
          <div className="flex gap-[32px] overflow-hidden">
            {bestSellers.map((product, idx) => (
              <Link key={idx} to={`/product/${product.name.toLowerCase().replace(/\s+/g, '-')}`} className="flex-shrink-0 cursor-pointer group" style={{ width: '320px' }}>
      ...
      <section className="w-full min-h-[900px] bg-gradient-to-b from-[#FDFBF7] to-[#F9F4EE] py-[96px]">
        ...
        <div className="px-[120px] mb-[80px]">
          <div className="flex items-start gap-[48px]">
            ...
            <div className="flex-1 bg-white rounded-[24px] shadow-[0_12px_48px_rgba(0,0,0,0.10)] p-[56px]">
              ...
              <div className="space-y-4">
                <Link to="/product/ethereal-glow-concentrate">
                  <button className="w-full h-[56px] bg-[#8B7355] text-white text-[15px] font-semibold rounded-[4px] tracking-[1px] hover:bg-[#7a6448] transition-colors">Pre-Order Now</button>
                </Link>
                <button className="w-full h-[56px] border-[2px] border-[#8B7355] bg-transparent text-[#8B7355] text-[15px] font-semibold rounded-[4px] tracking-[1px] hover:bg-[#8B7355] hover:text-white transition-all">Notify Me</button>
              </div>
            </div>
          </div>
        </div>
        <div className="px-[120px] mb-[64px]">
          <div className="flex gap-[32px] justify-center">
            {newArrivalsSupporting.map((product, idx) => (
              <Link key={idx} to={`/product/${product.name.toLowerCase().replace(/\s+/g, '-')}`} style={{ width: '376px' }} className="cursor-pointer group">
      ...
      <section className="w-full min-h-[620px] bg-gradient-to-b from-[#FDFBF7] to-[#FAF6F0] py-[96px]">
        ...
        <div className="px-[120px] flex gap-[56px] items-start">
          {testimonials.map((t, idx) => (
            <div key={idx} className="bg-white rounded-[12px] shadow-[0_6px_28px_rgba(0,0,0,0.07)] p-[52px]" style={{ width: '380px', marginTop: idx === 1 ? '-40px' : '0px' }}>
