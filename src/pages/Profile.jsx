  ...
  return (
    <div key={i18n.language} className="bg-[#FDFBF7] font-['Cormorant_Garamond'] min-h-screen">
      ...
      <div className="min-h-[200px] md:min-h-[240px] lg:min-h-[280px] bg-gradient-to-b from-[#F5F1EA] to-[#FDFBF7] px-4 md:px-[60px] lg:px-[120px] flex items-center py-8 md:py-0">
        <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6 md:gap-8 lg:gap-[48px] w-full">

          {/* Mobile Drawer Trigger */}
          <button
            onClick={() => setShowDrawer(true)}
            className="lg:hidden absolute top-0 right-0 flex items-center gap-2 bg-white border border-[#E8E3D9] rounded-full px-3 py-2 shadow-sm flex-shrink-0 z-10"
          >
            {userAvatar ? (
