...
export default function Notifications() {
  ...
  const NotificationRow = ({ item, onToggle }) => (
    <div className="flex items-center justify-between py-[14px] border-b border-[#F5F1EA] last:border-0 gap-4">
      <div className="flex-1">
        <h3 className="text-[16px] font-medium text-[#1A1A1A] mb-[4px]">{item.title}</h3>
        <p className="text-[13px] font-normal text-[#666666]">{item.description}</p>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto flex gap-[40px]">
          ...
          <div className="flex-1">
                ...
                {newsletterOptions.map((option) => (
                  ...
                  >
                    <div className="mt-[2px] flex-shrink-0">
                      <div className={`w-[20px] h-[20px] rounded-full border-[2px] flex items-center justify-center transition-all ${newsletter === option.value ? 'border-[#8B7355] bg-[#8B7355]' : 'border-[#E8E3D9]'}`}>
                        {newsletter === option.value && <div className="w-[8px] h-[8px] rounded-full bg-white" />}
                      </div>
                    </div>
                    <div className="flex-1">
                      <h3 className={`text-[16px] font-medium mb-[4px] ${newsletter === option.value ? 'text-[#8B7355]' : 'text-[#1A1A1A]'}`}>{option.label}</h3>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[24px]">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-white border-[1.5px] border-[#E8E3D9] rounded-[8px] px-[16px] py-[14px] text-[15px] font-normal text-[#1A1A1A] appearance-none cursor-pointer outline-none focus:border-[#8B7355] transition-colors pr-[44px]"
                >
                  <option>Daily</option>
                ...
                <IoChevronDown className="w-[20px] h-[20px] text-[#666666] absolute right-[16px] top-1/2 -translate-y-1/2 pointer-events-none" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-[16px] mb-[24px]">
              <button
                onClick={resetAll}
                className="flex-1 h-[56px] bg-white border-[1.5px] border-[#E8E3D9] text-[#666666] text-[16px] font-medium rounded-[8px] cursor-pointer hover:border-[#8B7355] hover:text-[#8B7355] transition-all"
              >
                Reset to Default
              </button>
