    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[180px] md:min-h-[200px] bg-gradient-to-b from-[#FDFBF7] to-white flex flex-col items-center justify-center py-8 md:py-[40px] px-4">
        ...
        <div className="bg-[#FDFBF7] border border-[#E8E3D9] rounded-[24px] px-5 lg:px-[28px] py-[10px] lg:py-[12px]">
          <span className="text-[16px] md:text-[18px] lg:text-[20px] font-medium text-[#8B7355]">Order #SL-2024-1892</span>
        </div>
      </div>
      ...
      <div className="min-h-[52px] bg-[#FDFBF7] border-y border-[#E8E3D9] px-4 md:px-[60px] lg:px-[120px] flex items-center justify-center gap-[10px] lg:gap-[12px] py-3 text-center">
        ...
        <span className="text-[13px] md:text-[14px] lg:text-[15px] font-normal text-[#666666]">
          A confirmation email has been sent to <span className="text-[#8B7355] font-medium">your@email.com</span>
        </span>
      </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-5 md:p-6 lg:p-[32px] mb-5 lg:mb-[24px]">
                ...
                {orderItems.map((item, index) => (
                  <div key={item.id}>
                    <div className="flex gap-3 md:gap-4 lg:gap-[16px]">
                      <img src={item.image} alt={item.name} className="w-[72px] h-[72px] md:w-[88px] md:h-[88px] lg:w-[100px] lg:h-[100px] rounded-[8px] object-cover flex-shrink-0" />
                      <div className="flex-1 min-w-0">
                        <div className="text-[11px] lg:text-[12px] font-medium text-[#8B7355] mb-[4px]">{item.brand}</div>
                        <div className="text-[14px] md:text-[15px] lg:text-[16px] font-normal text-[#1A1A1A] mb-[6px] lg:mb-[8px] leading-tight">{item.name}</div>
                        <div className="text-[13px] lg:text-[14px] font-normal text-[#666666]">{item.quantity} × ${item.price}</div>
                      </div>
                      <div className="flex items-start flex-shrink-0">
                        <span className="text-[14px] md:text-[15px] lg:text-[16px] font-semibold text-[#1A1A1A]">${(item.price * item.quantity).toFixed(2)}</span>
                      </div>
                    </div>
              ...
              <div className="pt-5 lg:pt-[24px] border-t border-[#E8E3D9]">
                <div className="space-y-3 lg:space-y-[12px] mb-4 lg:mb-[20px]">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[14px] lg:text-[16px] font-normal text-[#666666]">Shipping (Standard Delivery)</span>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-5 md:p-6 lg:p-[32px]">
              ...
              <div className="mb-4 lg:mb-[20px]">
                ...
                <div className="text-[15px] lg:text-[16px] font-semibold text-[#1A1A1A] mb-[4px]">John Smith</div>
              ...
              <div className="mb-4 lg:mb-[20px]">
                ...
                <div className="flex items-center gap-[8px] mb-[4px]">
                  ...
                  <span className="text-[14px] lg:text-[16px] font-semibold text-[#1A1A1A]">Standard Delivery</span>
                </div>
                <div className="text-[13px] lg:text-[15px] font-normal text-green-600">Estimated delivery: Dec 12–15, 2024</div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 lg:gap-[12px]">
                  <div className="w-[44px] h-[26px] lg:w-[48px] lg:h-[28px] rounded-[4px] bg-blue-50 flex items-center justify-center">
                    <span className="text-[12px] lg:text-[13px] font-bold text-[#1434CB]">VISA</span>
                  </div>
                  <div className="flex items-center gap-[8px]">
                    <IoCardOutline className="w-[16px] h-[16px] lg:w-[18px] lg:h-[18px] text-[#666666]" />
                    <span className="text-[14px] lg:text-[16px] font-normal text-[#1A1A1A]">Visa ending in 4242</span>
                  </div>
                </div>
              </div>
            </div>
