      ...
      <div className="min-h-[600px] px-[120px] py-[48px]">
        <div className="max-w-[1200px] mx-auto flex gap-[40px]">
          ...
          <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-[16px] mb-[16px]">
                  {savedCards.map((card) => (
                    <div
                      ...
                      className={`rounded-[8px] p-[20px] cursor-pointer transition-all ${
                    ...
                    >
                      <div className="flex items-start gap-[12px]">
                        <div className={`w-[20px] h-[20px] rounded-full border-[2px] flex items-center justify-center mt-[2px] flex-shrink-0 ${
                          ...
                          {selectedCard === card.id && <div className="w-[10px] h-[10px] rounded-full bg-[#8B7355]" />}
                        </div>
                        <div className="flex-1">
                          <div className={`inline-flex items-center justify-center w-[48px] h-[28px] rounded-[4px] text-[13px] font-bold mb-[12px] ${card.labelBg} ${card.labelColor}`}>
                            {card.label}
                          </div>
                          <div className="text-[18px] font-semibold text-[#1A1A1A] mb-[4px]">•••• {card.last4}</div>
              ...
              <div className="space-y-[12px]">
                {paymentMethods.map((method) => (
                  <div
                    ...
                    className={`p-[16px] rounded-[8px] cursor-pointer flex items-center gap-[16px] transition-all ${
                  ...
                  >
                    <div className={`w-[20px] h-[20px] rounded-full border-[2px] flex items-center justify-center flex-shrink-0 ${
                      ...
                      {selectedMethod === method.id && <div className="w-[10px] h-[10px] rounded-full bg-[#8B7355]" />}
                    </div>
                    <method.icon className={`w-[24px] h-[24px] flex-shrink-0 ${selectedMethod === method.id ? 'text-[#8B7355]' : 'text-[#666666]'}`} />
                    <div className="flex-1">
                      <span className="text-[16px] font-medium text-[#1A1A1A]">{method.name}</span>
                      <p className="text-[13px] font-normal text-[#999999]">{method.sublabel}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Card Details Form */}
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[24px]">
              <h3 className="text-[20px] font-semibold text-[#1A1A1A] mb-[24px]">Card Details</h3>
                ...
                <div className="grid grid-cols-2 gap-[16px]">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <IoLockClosedOutline className="w-[16px] h-[16px] text-[#999999] absolute right-[16px] top-1/2 -translate-y-1/2" />
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] mb-[24px]">
              ...
              <div className="space-y-[12px]">
                <div
                  ...
                  className={`flex items-center gap-[12px] p-[16px] rounded-[8px] cursor-pointer transition-all ${
                    sameAddress ? 'bg-[#FDFBF7] border-[2px] border-[#8B7355]' : 'bg-white border border-[#E8E3D9] hover:border-[#C9A870]'
                  }`}
                >
                  <div className={`w-[20px] h-[20px] rounded-full border-[2px] flex items-center justify-center flex-shrink-0 ${sameAddress ? 'border-[#8B7355]' : 'border-[#E8E3D9]'}`}>
                    {sameAddress && <div className="w-[10px] h-[10px] rounded-full bg-[#8B7355]" />}
                  </div>
            ...
            <div className="grid grid-cols-3 gap-[20px]">
              {securityFeatures.map((feature, idx) => (
                <div key={idx} className="bg-[#FDFBF7] rounded-[8px] p-[20px] flex flex-col items-center text-center">
          ...
          <div className="w-[360px] flex-shrink-0">
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px] sticky top-[24px]">
              ...
              <div className="flex gap-[8px] mb-[24px]">
                ...
                <button className="h-[40px] px-[20px] bg-[#8B7355] text-white text-[14px] font-medium rounded-[8px] cursor-pointer hover:bg-[#7a6448] transition-colors">Apply</button>
              </div>
              ...
              <div className="flex items-start gap-[12px] mb-[24px]">
                ...
                />
                <label htmlFor="terms" className="text-[14px] font-normal text-[#666666] cursor-pointer leading-[1.5]">
              ...
              <div className="space-y-[16px] mb-[24px]">
                <button className={`w-full h-[56px] text-white text-[16px] font-medium rounded-[8px] cursor-pointer transition-all ${agreeTerms ? 'bg-[#8B7355] hover:bg-[#7a6448]' : 'bg-[#C9A870] cursor-not-allowed'}`}>
                  Place Order
                </button>
                <Link to="/delivery-methods">
                  <button className="w-full flex items-center justify-center gap-[8px] text-[14px] font-medium text-[#666666] cursor-pointer hover:text-[#8B7355] transition-colors">
